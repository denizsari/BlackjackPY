        ...
        if player_has_stood:
            ...
            if deck.calculate_hand_value(player.hand) == 21 and len(player.hand) == 2:
                ...
                if not player.wins_displayed:
                    ...
                    user_new_balance = player.total_bet * 1.5 + player.balance
                ...
                if not player.wins_displayed:
                    ...
                    player.balance = user_new_balance
                    pygame.draw.rect(screen, GREEN, (1100, 700, 200, 300))
                    display_text(screen, custom_font, f"Bakiye: {player.balance}M", (255, 255, 255), 1100, 700)
                ...
                if not player.wins_displayed:
                    user_new_balance = player.balance
                    pygame.draw.rect(screen, GREEN, (1100, 700, 300, 300))
                    display_text(screen, custom_font, f"Bakiye: {player.balance}M", (255, 255, 255), 1100, 700)
                # Display text for player loss
                display_text(screen, custom_font, f"Oyuncu Kaybeder!", (255, 255, 255), center_x, center_y)
                player.wins_displayed = True
                round_ended = True # Indicates the round has ended
            
            display_text(screen, custom_font, f"Tekrar oynamak için tıkla!", (255, 255, 255), center_x, 450) # Prompt to start a new round
